                            ...
                            <div class="p-5">
                                ...
                                <form class="user">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="nim" name="nim" aria-describedby="emailHelp" placeholder="NIM..." required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?= base_url() ?>auth/check">Create an Account!</a>
                                </div>
                            </div>
                        </div>
                    </div>
