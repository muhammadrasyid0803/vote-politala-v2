    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Presma</h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/list_presmaPL') ?>",
                "type": "POST"
            },
    ...
    function edit_presma(no_urut) {
        ...
        $.ajax({
            url: "<?php echo site_url('Admin/edit_presma') ?>/" + no_urut,
            type: "GET",
            dataType: "JSON",
    ...
    function simpan() {
        ...
        if (save_method == 'add') {
            ...
            url = "<?php echo site_url('admin/update_presma') ?>";
        }
    ...
    function delete_presma(no_urut) {
        if (confirm('Are you sure delete this data?')) {
            // ajax delete data to database
            $.ajax({
                url: "<?php echo site_url('Admin/delete_presma/') ?>/" + no_urut,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
